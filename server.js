...
if (globalThis.__DATA__.cropLots.length === 0) {
  globalThis.__DATA__.cropLots = [
    { id: '#L-4092', crop: 'Wheat', grade: 'Grade A (Lok-1)', quantity: '150 Quintals', quantityVal: 150, bestOffer: '₹4,11,000', bestOfferRate: '₹2,740/q', status: 'Negotiating (2)', farmerName: 'Jai Kumar', location: 'Karnal, HR', harvestDate: 'Oct 2024', moisture: '10.5%' },
    { id: '#L-4088', crop: 'Soybean', grade: 'Standard Yellow', quantity: '85 Quintals', quantityVal: 85, bestOffer: 'No offers yet', status: 'Published', farmerName: 'Jai Kumar', location: 'Karnal, HR', harvestDate: 'Nov 2024', moisture: '9.2%' },
    { id: '#L-4075', crop: 'Basmati Rice', grade: 'Pusa 1121 Export', quantity: '200 Quintals', quantityVal: 200, bestOffer: '₹7,60,000', bestOfferRate: '₹3,800/q', status: 'Negotiating (1)', farmerName: 'Jai Kumar', location: 'Karnal, HR', harvestDate: 'Sep 2024', moisture: '11.0%' },
    { id: '#L-4060', crop: 'Mustard', grade: 'Pusa Bold (>42% Oil)', quantity: '60 Quintals', quantityVal: 60, bestOffer: '₹3,42,000', bestOfferRate: '₹5,700/q', status: 'Published', farmerName: 'Jai Kumar', location: 'Karnal, HR', harvestDate: 'Oct 2024', moisture: '8.5%' }
  ];
  globalThis.__DATA__.buyerRequirements = [
    ...
    { id: 'REQ-103', title: '25 Tons Basmati Rice', crop: 'Basmati Rice', quantity: '25 Tons', dueDate: '15 Nov', deliveryLocation: 'Kandla Port', iconType: 'rice' }
  ];
  ...
  globalThis.__DATA__.availableLots = [
    { id: 'LOT-301', crop: 'Basmati Rice (Pusa 1121)', quality: 'Moisture <12%', seller: 'Karnal Farmers Co-op', location: 'Karnal, HR', volume: '50 MT', estPrice: '₹8,100/q', status: 'Verified' },
    ...
    { id: 'LOT-303', crop: 'Cotton (MCU-5)', quality: 'Staple 30mm+', seller: 'Gujarat Agri FPO', location: 'Rajkot, GJ', volume: '100 Bales', estPrice: '₹7,400/q', status: 'Organic Certified' },
    { id: 'LOT-304', crop: 'Mustard (High Oil)', quality: 'Oil content >42%', seller: 'Bharatpur Agro', location: 'Bharatpur, RJ', volume: '30 MT', estPrice: '₹5,650/q', status: 'Verified' }
  ];
  ...
  globalThis.__DATA__.mandiComparisons = [
    { market: 'Azadpur Mandi', basePrice: 2850, distanceKm: 45, transportCost: -120, netRealization: 2730 },
    { market: 'Narela Mandi', basePrice: 2780, distanceKm: 12, transportCost: -40, netRealization: 2740 },
    { market: 'Najafgarh Mandi', basePrice: 2700, distanceKm: 8, transportCost: -25, netRealization: 2675 }
  ];
