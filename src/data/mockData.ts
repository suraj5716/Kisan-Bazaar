...
export const ASSETS = {
  ...
  satelliteKarnal: 'https://lh3.googleusercontent.com/aida-public/AB6AXuARFb5CfLVybVMazbTugg6WAkLb-pxITIFHunMkUpmOS97Zg0PZXW2rDAHFJ_MCli1S-xHKMfj-w-l0aOzSqhWzcl7RWR07e2L4DAWnCT9fiv-eaGaFCZlJvsVAs7GwgqSl1ci7gg372PhWsSWYX94NYbYUaXow2SfybcMybrZ39h9h0fmV-dpFMRR0fA0tSdQgl7E6Hc3VdZIYSXyLF5zxFM0Y9tVMhfbDBppjL3aI3MLmdq3q5mv76w',
  satelliteUjjain: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB68MR3MFWvwjMxArawD7ApaW3h1MHhSqnH_0p-s4cXCNGnncqQck8rUWEOStSAAERqfXk1k1GKwacZyGIXnEbOxvM54lLLKqBSic05gkJwGwBdaDM_bBUqwwX67XHBXHJbuG3mNv46VdEph6rxYefZKJP5dq4AQ9Z_wEYEJuvdeltzDs3ewvUmbtqyyMqF52gWqYdjCJQnZfklZCjWRGc7_OyVBziHWGj6zlajObhh25lszyufeCrn0Q',
...
export const RECENT_ACTIVITIES: RecentActivityItem[] = [
  {
    ...
    meta: 'Dist: Nashik • 10 mins ago',
    colorType: 'primary'
  },
  {
    id: 'ACT-2',
    icon: 'payments',
    title: 'Large Tx: ₹1.2M (Soybean)',
    meta: 'Buyer: Reliance Retail • 45 mins ago',
    colorType: 'secondary'
  },
  {
    id: 'ACT-3',
    ...
    meta: 'Market: Lasalgaon • 1 hr ago',
    colorType: 'error'
  },
  {
    id: 'ACT-4',
